...
$.ui.mouse = {
	...
	mouseMove: function(e) {
		...
		if ($.browser && $.browser.msie && !e.button) {
...
$.widget("ui.draggable", $.extend($.ui.mouse, {
	...
	mouseStart: function(e) {
		...
		if(this.offsetParent[0] == document.body && $.browser &&  $.browser.mozilla) po = { top: 0, left: 0 };		//Ugly FF3 fix
...
function contains(a, b) { 
    var safari2 = $.browser && $.browser.safari && $.browser.version < 522;
